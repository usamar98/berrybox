import { configuredCharacterModels, configuredGameModels, configuredTemplateModels, templateGenerationAvailable } from "@/lib/3d/fal";
...
export function GET() {
  ...
  return Response.json({
    providers: [
      ...
      { feature: "3d-character", provider: "fal.ai", configured: keyConfigured && configuredCharacterModels().length > 0, enabled: false, status: "coming-soon", models: configuredCharacterModels() },
